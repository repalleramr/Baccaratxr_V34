...
function load(){const raw=localStorage.getItem(STATE_KEY); s=raw?JSON.parse(raw):JSON.parse(JSON.stringify(DEF)); if(!s.ladder.length) buildLadder();}
